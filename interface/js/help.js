const helpData = {
  ...
  developers: {
    ...
    faqs: [
        { q: "Why is the HTML code so long?", a: "Email clients require **inline CSS**. The builder takes the styling and embeds it directly into every relevant HTML tag to maximize compatibility across clients like Outlook and Gmail." },
